...
export default function Lotes () {
  ...
  return (
    <div className='flex flex-col py-5 gap-4'>
      <h5 className='text-xl text-gray-800 font-semibold mb-3'>Lotes</h5>
            ...
            {filterList().map(l => (
              <tr key={l.id_lote} className='border-b border-gray-200'>
                ...
                <td className='py-3 px-6 text-left whitespace-nowrap flex items-center gap-2'>
                  <Link to={`/lotes/edit/${l.id_lote}`} className='p-2 bg-green-600 text-white rounded-md hover:bg-opacity-80'>
